...
reported to the project maintainers privately through GitHub - open a private
report via the repository's "Security" tab -> "Report a vulnerability"
(<https://github.com/rivassec/secure-iam-lint/security/advisories/new>), which
reaches only the maintainers, or contact the maintainer via their GitHub profile
(@rivassec). All complaints will be reviewed and investigated promptly and
