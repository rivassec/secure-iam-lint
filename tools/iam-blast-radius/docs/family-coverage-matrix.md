...
|---|---|---|---|---|---|---|
| Identity | `engine/rules.js` + `engine/escalation.js` | Yes (auto) | Analyzed as identity | n/a | `PASSROLE-*`, `ROLE-TAKEOVER`, `WILDCARD-ACTION/RESOURCE`, `DIRECT-IAM-ADMIN`, `ATTACH-POLICY`, `POLICY-VERSION`, `CREDENTIAL-*`, `ASSUME-ROLE-EXPANSION`, `COMPUTE-CODE-OVERWRITE`, `CROSS-ACCOUNT-ASSUME-ROLE`, `RESOURCE-POLICY-WRITE`, `DATA-READ`, `DESTRUCTIVE-ACTION`, ... | suite-1 1-14/19-24, suite-2 34-48/50/54 |
