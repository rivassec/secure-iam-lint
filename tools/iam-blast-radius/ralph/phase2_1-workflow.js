export const meta = {
  name: 'iam-blast-radius-ralph-phase2-1',
  description: 'Phase 2.1 Ralph loop: subsumption consistency + summary metric + grammar; graph certainty vocabulary + can-decrypt edge',
...
const STORIES = [
  { id: 'IAM-201', maxIter: 4, ui: false },
  { id: 'IAM-202', maxIter: 4, ui: true },
]
