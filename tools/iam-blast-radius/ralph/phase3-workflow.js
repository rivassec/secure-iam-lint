export const meta = {
  name: 'iam-blast-radius-ralph-phase3',
  description: 'Phase 3 Ralph loop: negative regression corpus (author+validate the does-not-fire truth, then fix the engine to match)',
...
const STORIES = [
  { id: 'IAM-301', maxIter: 4, ui: false },
  { id: 'IAM-302', maxIter: 6, ui: false },
]
